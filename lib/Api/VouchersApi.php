...
class VouchersApi
{
    ...
    protected function findVoucherRequest($medium = null, $purpose = null, $team = null, $channel = null, $customer_identifier = null)
    {
        ...
        // query params
        if (is_array($medium)) {
            $medium = ObjectSerializer::serializeCollection($medium, 'multi', true);
        }
        if ($medium !== null) {
        ...
        // query params
        if (is_array($purpose)) {
            $purpose = ObjectSerializer::serializeCollection($purpose, 'multi', true);
        }
        if ($purpose !== null) {
        ...
        // query params
        if (is_array($team)) {
            $team = ObjectSerializer::serializeCollection($team, 'multi', true);
        }
        if ($team !== null) {
        ...
        if ($customer_identifier !== null) {
            $queryParams['customer_identifier'] = ObjectSerializer::toQueryValue($customer_identifier);
        }
     ...
     * @return \Vouchery\Model\Voucher[]
     */
    public function getVouchers($campaign_id)
    {
        list($response) = $this->getVouchersWithHttpInfo($campaign_id);
        return $response;
    }
     ...
     * @return array of \Vouchery\Model\Voucher[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getVouchersWithHttpInfo($campaign_id)
    {
        $request = $this->getVouchersRequest($campaign_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsync($campaign_id)
    {
        return $this->getVouchersAsyncWithHttpInfo($campaign_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsyncWithHttpInfo($campaign_id)
    {
        $returnType = '\Vouchery\Model\Voucher[]';
        $request = $this->getVouchersRequest($campaign_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVouchersRequest($campaign_id)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Vouchery\Model\Voucher
     */
    public function updateVoucher($code, $voucher = null)
    {
        list($response) = $this->updateVoucherWithHttpInfo($code, $voucher);
        return $response;
    }
     ...
     * @return array of \Vouchery\Model\Voucher, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateVoucherWithHttpInfo($code, $voucher = null)
    {
        $request = $this->updateVoucherRequest($code, $voucher);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsync($code, $voucher = null)
    {
        return $this->updateVoucherAsyncWithHttpInfo($code, $voucher)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherAsyncWithHttpInfo($code, $voucher = null)
    {
        $returnType = '\Vouchery\Model\Voucher';
        $request = $this->updateVoucherRequest($code, $voucher);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateVoucherRequest($code, $voucher = null)
    {
        // verify the required parameter 'code' is set
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException(
