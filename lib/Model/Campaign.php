...
class Campaign implements ModelInterface, ArrayAccess
{
     ...
     * Sets template
     *
     * @param string|null $template Valid template values for MainCampaign are: discount, loyalty, gift_card. For SubCampaign valid templates are sub_redemption, sub_reward_points, sub_generate_vouchers.
     *
     * @return $this
     */
