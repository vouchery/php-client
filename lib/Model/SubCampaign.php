 ...
 * @link     https://openapi-generator.tech
 */
class SubCampaign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sub_Campaign';
    ...
    protected static $openAPITypes = [
        ...
        'vouchers_distributed_count' => 'int',
        'vouchers_count' => 'int',
        'currency' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'voucher_max_redemptions' => 'voucher_max_redemptions',
    ...
    protected static $setters = [
        ...
        'total_budget_spent' => 'setTotalBudgetSpent',
        'vouchers_distributed_count' => 'setVouchersDistributedCount',
        ...
        'voucher_max_redemptions' => 'setVoucherMaxRedemptions',
    ...
    protected static $getters = [
        ...
        'total_budget_spent' => 'getTotalBudgetSpent',
        'vouchers_distributed_count' => 'getVouchersDistributedCount',
        ...
        'voucher_max_redemptions' => 'getVoucherMaxRedemptions',
    ...
    const TEMPLATE_REDEMPTION = 'sub_redemption';
    const TEMPLATE_REWARD_POINTS = 'sub_reward_points';
    const TEMPLATE_GENERATE_VOUCHERS = 'sub_generate_vouchers';
    ...
    {
        return [
            self::TEMPLATE_REDEMPTION,
            self::TEMPLATE_REWARD_POINTS,
            self::TEMPLATE_GENERATE_VOUCHERS,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['redemptions_count'] = isset($data['redemptions_count']) ? $data['redemptions_count'] : null;
        $this->container['total_budget_spent'] = isset($data['total_budget_spent']) ? $data['total_budget_spent'] : null;
        $this->container['vouchers_distributed_count'] = isset($data['vouchers_distributed_count']) ? $data['vouchers_distributed_count'] : null;
        $this->container['vouchers_count'] = isset($data['vouchers_count']) ? $data['vouchers_count'] : null;
        ...
        $this->container['voucher_max_redemptions'] = isset($data['voucher_max_redemptions']) ? $data['voucher_max_redemptions'] : null;
     ...
     * Sets type
     *
     * @param string $type This field is required only when you create a campaign
     *
     * @return $this
     */
     ...
     * Sets parent_id
     *
     * @param int $parent_id Main campaign ID
     *
     * @return $this
     */
     ...
     * Sets template
     *
     * @param string|null $template Valid templates are sub_redemption, sub_reward_points, sub_generate_vouchers.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $max_total_budget The budget available for discount campaign.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $max_redemptions The maximum number of redemptions available.
     *
     * @return $this
     */
     ...
     * Sets max_discount
     *
     * @param float|null $max_discount max_discount
     *
     * @return $this
     */
     ...
     *
     * @param float|null $redemptions_count redemptions_count
     *
     * @return $this
     */
    ...
    /**
     * Gets total_budget_spent
     *
     * @return float|null
     */
    public function getTotalBudgetSpent()
    {
        return $this->container['total_budget_spent'];
    }

    /**
     * Sets total_budget_spent
     *
     * @param float|null $total_budget_spent total_budget_spent
     *
     * @return $this
     */
    public function setTotalBudgetSpent($total_budget_spent)
    {
        $this->container['total_budget_spent'] = $total_budget_spent;

        return $this;
    }

    /**
     * Gets vouchers_distributed_count
     *
     * @return int|null
     */
    public function getVouchersDistributedCount()
    {
        return $this->container['vouchers_distributed_count'];
    }

    /**
     * Sets vouchers_distributed_count
     *
     * @param int|null $vouchers_distributed_count vouchers_distributed_count
     *
     * @return $this
     */
    public function setVouchersDistributedCount($vouchers_distributed_count)
    {
        $this->container['vouchers_distributed_count'] = $vouchers_distributed_count;
     ...
     * Sets vouchers_count
     *
     * @param int|null $vouchers_count vouchers_count
     *
     * @return $this
     */
    ...
    /**
     * Gets voucher_max_redemptions
     *
     * @return float|null
     */
    public function getVoucherMaxRedemptions()
    {
        return $this->container['voucher_max_redemptions'];
    }

    /**
     * Sets voucher_max_redemptions
     *
     * @param float|null $voucher_max_redemptions The maximum number of redemptions per unique voucher code.
     *
     * @return $this
     */
    public function setVoucherMaxRedemptions($voucher_max_redemptions)
    {
        $this->container['voucher_max_redemptions'] = $voucher_max_redemptions;
    ...
    public function setVoucherRandomPartLength($voucher_random_part_length)
    {
        ...
        if (!is_null($voucher_random_part_length) && ($voucher_random_part_length > 10)) {
            throw new \InvalidArgumentException('invalid value for $voucher_random_part_length when calling SubCampaign., must be smaller than or equal to 10.');
        }
        if (!is_null($voucher_random_part_length) && ($voucher_random_part_length < 3)) {
            throw new \InvalidArgumentException('invalid value for $voucher_random_part_length when calling SubCampaign., must be bigger than or equal to 3.');
        }
