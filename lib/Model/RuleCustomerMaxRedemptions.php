...
class RuleCustomerMaxRedemptions implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_CUSTOMER_MAX_REDEMPTIONS = 'customer_max_redemptions';
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'customer_max_redemptions';
     ...
     * Sets type
     *
     * @param string $type Limit the number of redemptions customer can redeem within subcampaign.
     *
     * @return $this
     */
