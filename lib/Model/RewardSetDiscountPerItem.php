...
class RewardSetDiscountPerItem implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_SET_DISCOUNT_PER_ITEM = 'set_discount_per_item';
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'set_discount_per_item';
     ...
     * Sets type
     *
     * @param string $type Set discount for specific item in trigger data. Returns false if item is not found.
     *
     * @return $this
     */
