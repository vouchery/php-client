...
/**
 * RewardAssignVoucher Class Doc Comment
 *
 * @category Class
 * @package  Vouchery
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RewardAssignVoucher implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RewardAssignVoucher';
    ...
    const TYPE_ASSIGN_VOUCHER = 'assign_voucher';
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'assign_voucher';
     ...
     * Sets type
     *
     * @param string|null $type This reward assigns existing voucher from specific subcampaign to the customer, who generated the trigger.
     *
     * @return $this
     */
     ...
     *
     * @param float $voucher_campaign_id Subcampaign ID, voucher is related to.
     *
     * @return $this
     */
