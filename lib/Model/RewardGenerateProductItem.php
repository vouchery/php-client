...
class RewardGenerateProductItem implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_GENERATE_PRODUCT_ITEM = 'generate_product_item';
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'generate_product_item';
     ...
     * Sets type
     *
     * @param string $type This reward generates product item and return it in trigger response.
     *
     * @return $this
     */
