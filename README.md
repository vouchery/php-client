...
*CampaignsApi* | [**getMainCampaign**](docs/Api/CampaignsApi.md#getmaincampaign) | **GET** /main_campaigns/{id} | Get a main campaign
*CampaignsApi* | [**getMainCampaigns**](docs/Api/CampaignsApi.md#getmaincampaigns) | **GET** /main_campaigns | Get main campaigns with children by params
...
*CompanyApi* | [**updateCompany**](docs/Api/CompanyApi.md#updatecompany) | **PATCH** /company | Update company details
...
*ProjectsApi* | [**updateProject**](docs/Api/ProjectsApi.md#updateproject) | **PATCH** /project | Update project settings
...
*SubscriptionsApi* | [**createSubscription**](docs/Api/SubscriptionsApi.md#createsubscription) | **POST** /subscriptions | Create a subscription
...
*SubscriptionsApi* | [**getSubscriptions**](docs/Api/SubscriptionsApi.md#getsubscriptions) | **GET** /subscriptions | Get all subscriptions for a project
*SubscriptionsApi* | [**verifySubscription**](docs/Api/SubscriptionsApi.md#verifysubscription) | **GET** /subscriptions/{id}/verify | Verify subscription callback URL
*TriggersApi* | [**createTrigger**](docs/Api/TriggersApi.md#createtrigger) | **POST** /triggers | Create a trigger
*UsersApi* | [**getMe**](docs/Api/UsersApi.md#getme) | **GET** /me | Get information about current user and project
*UsersApi* | [**getUser**](docs/Api/UsersApi.md#getuser) | **GET** /users/{email} | Get a user
*UsersApi* | [**getUsers**](docs/Api/UsersApi.md#getusers) | **GET** /users | Get all users within a project
*UsersApi* | [**postUsers**](docs/Api/UsersApi.md#postusers) | **POST** /users | Create project user
*UsersApi* | [**updateUser**](docs/Api/UsersApi.md#updateuser) | **PATCH** /users/{email} | Update a user
...
*VouchersApi* | [**expireVoucher**](docs/Api/VouchersApi.md#expirevoucher) | **PATCH** /vouchers/{code}/expire | Expire a voucher
...
## Documentation For Models
 ...
 - [CampaignCreatedBy](docs/Model/CampaignCreatedBy.md)
 ...
 - [MainCampaign](docs/Model/MainCampaign.md)
 ...
 - [RewardSetDiscountPerItemItemConditions](docs/Model/RewardSetDiscountPerItemItemConditions.md)
 - [Rule](docs/Model/Rule.md)
 - [RuleAdditionalCategory](docs/Model/RuleAdditionalCategory.md)
 ...
 - [RuleProductCategory](docs/Model/RuleProductCategory.md)
 ...
 - [RuleTimeframeOneOf](docs/Model/RuleTimeframeOneOf.md)
 - [RuleTimeframeOneOf1](docs/Model/RuleTimeframeOneOf1.md)
 - [RuleTimeframeOneOf2](docs/Model/RuleTimeframeOneOf2.md)
 - [RuleTriggersAmount](docs/Model/RuleTriggersAmount.md)
 - [SubCampaign](docs/Model/SubCampaign.md)
